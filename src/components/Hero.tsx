      ...
      <div className="container mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-4">
            <a
              ...
              className="flex items-center gap-2 bg-yellow-500 text-white px-6 py-3 rounded-full shadow-lg hover:bg-pink-600 transition"
            >
            ...
            <a
              href="#servicos"
              className="border border-yellow-500 text-white px-6 py-3 rounded-full hover:bg-pink-50 transition"
            >
              Nossos Serviços
            </a>
          </div>
        ...
        <div className="relative flex justify-center items-center">
          ...
          <motion.img
            ...
            alt="Borda de patas"
            className="absolute w-96 h-96 object-cover"
